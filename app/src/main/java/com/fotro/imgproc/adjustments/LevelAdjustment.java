...
public class LevelAdjustment extends Adjustment {
    ...
    public void importObject(JSONObject object) throws ImgProcException {
        ...
        mRedIn = extractInParam(object, RED);
        mRedOut = extractOutParam(object, RED);

        mGreenIn = extractInParam(object, GREEN);
        mGreenOut = extractOutParam(object, GREEN);

        mBlueIn = extractInParam(object, BLUE);
        mBlueOut = extractOutParam(object, BLUE);
    }

    private double[] extractInParam(JSONObject object, String channel) throws ImgProcException {
        try {
    ...
    private double[] extractOutParam(JSONObject object, String channel) throws ImgProcException {
        try {
