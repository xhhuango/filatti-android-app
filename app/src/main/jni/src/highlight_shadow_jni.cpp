...
JNIEXPORT jboolean JNICALL Java_com_filatti_effects_adjusts_HighlightShadowAdjust_nativeHasEffect
(JNIEnv *env, jclass clazz, jlong thiz)
{
    return ((HighlightShadow*) thiz)->has_effect();
}

JNIEXPORT jfloat JNICALL Java_com_filatti_effects_adjusts_HighlightShadowAdjust_nativeGetAmount
(JNIEnv *env, jclass clazz, jlong thiz, jint tone)
{
    HighlightShadow* obj = (HighlightShadow*) thiz;
    return (jfloat) obj->get_amount(static_cast<Tone>((ToneRawType) tone));
}

JNIEXPORT jboolean JNICALL Java_com_filatti_effects_adjusts_HighlightShadowAdjust_nativeSetAmount
(JNIEnv *env, jclass clazz, jlong thiz, jint tone, jfloat amount)
{
    try {
...
JNIEXPORT jfloat JNICALL Java_com_filatti_effects_adjusts_HighlightShadowAdjust_nativeGetToneWidth
(JNIEnv *env, jclass clazz, jlong thiz, jint tone)
{
    HighlightShadow* obj = (HighlightShadow*) thiz;
    return (jfloat) obj->get_tone_width(static_cast<Tone>((ToneRawType) tone));
}

JNIEXPORT jboolean JNICALL Java_com_filatti_effects_adjusts_HighlightShadowAdjust_nativeSetToneWidth
(JNIEnv *env, jclass clazz, jlong thiz, jint tone, jfloat width)
{
    try {
